...
export const adminApi = {
  ...
  updateUserStatus: (id: string, status: string) => api.patch('/admin/users', { status }, { params: { id } }),
  updateUserRole: (id: string, role: string) => api.patch('/admin/users', { role }, { params: { id } }),
